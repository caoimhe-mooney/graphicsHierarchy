...
#define MESH_NAME "C:/Users/Caoimhe/Documents/graphics/modelLab/cube.dae"
#define MESH_NAME_2 "C:/Users/Caoimhe/Documents/graphics/modelLab/only_quad_sphere.dae"
/*----------------------------------------------------------------------------
----------------------------------------------------------------------------*/
...
void display() {
	...
	modelChild2 = translate(modelChild2, vec3(0.0f, -1.7f, 0.0f));
	//modelChild2 = rotate_y_deg(modelChild2, rotate_y_2);
	modelChild2 = modelChild2 * rotation2;
	...
	modelChild3 = scale(modelChild3, vec3(0.5, 0.5, 0.5));
	modelChild3 = translate(modelChild3, vec3(0.3f, -0.7f, 0.0f));	
	...
	//modelChild4 = rotate_z_deg(modelChild4, -2*rotate_y);
	mat4 modelChild4 = identity_mat4();
	modelChild4 = scale(modelChild4, vec3(0.5, 0.5, 0.5));
	modelChild4 = translate(modelChild4, vec3(-0.3f, -0.75f, 0.0f));
	modelChild4 = modelChild4 * rotation;
	// Apply the root matrix to the child matrix
	mat4 Child4 = model * modelChild * modelChild2 * modelChild4;
	...
	modelChild5 = scale(modelChild5, vec3(0.7, 0.7, 0.7));
	modelChild5 = translate(modelChild5, vec3(0.0f, -1.4f, 0.0f));

	mat4 Child5 = model * modelChild * modelChild2 * modelChild4 * modelChild5;
	...
	/*mat4 modelChild2 = identity_mat4();
	modelChild2 = translate(modelChild2, vec3(0.0f, -1.9f, 0.0f));

	modelChild2 = model * modelChild * modelChild2;
	...
	mat4 modelChild3 = identity_mat4();
	modelChild3 = scale(modelChild3, vec3(0.5, 0.5, 0.5));
	modelChild3 = translate(modelChild3, vec3(0.3f, 1.0f, 0.0f));

	// Apply the root matrix to the child matrix
	modelChild3 = model * modelChild * modelChild2 * modelChild3;

	// Update the appropriate uniform and draw the mesh again
	glUniformMatrix4fv(matrix_location, 1, GL_FALSE, modelChild3.m);
	glBindVertexArray(VAO[0]);
	glDrawArrays(GL_TRIANGLES, 0, mesh_data.mPointCount);

	mat4 modelChild4 = identity_mat4();
	modelChild4 = scale(modelChild4, vec3(0.7, 0.7, 0.7));
	modelChild4 = translate(modelChild4, vec3(-0.3f, -1.0f, 0.0f));
	modelChild4 = translate(modelChild4, vec3(0.0f, 3.0f, -3.0f));

	// Apply the root matrix to the child matrix
	modelChild4 = model * modelChild * modelChild2 * modelChild3 * modelChild4;
	...
	/*mat4 modelChild2 = identity_mat4();
	modelChild2 = rotate_z_deg(modelChild2, 180);
	modelChild2 = rotate_y_deg(modelChild2, rotate_y);
	modelChild2 = translate(modelChild2, vec3(0.0f, 3.9f, 0.0f));
...
void init()
{
	...
	glBindVertexArray(VAO[1]);
	mesh_data1 = load_mesh(MESH_NAME_2);
...
void keypress(unsigned char key, int x, int y) {
	...
	if (key == 'z') {
		//Translate the base, etc.
		rotation = rotate_z_deg(rotation, -10);
	}
	if (key == 'a') {
		//Translate the base, etc.
		rotation = rotate_z_deg(rotation, 10);
	...
	if (key == 'c') {
		//Translate the base, etc.
		rotation2 = rotate_z_deg(rotation2, -10);
	}
	if (key == 'd') {
		//Translate the base, etc.
		rotation2 = rotate_z_deg(rotation2, 10);
